...
> **CRITICAL:** Once saved, a **Primary endpoint URL** will appear (e.g., `https://skoolstorage13578642.z13.web.core.windows.net/`). Copy this URL. This is your website's address.
...
2. Paste the following simple HTML code:
